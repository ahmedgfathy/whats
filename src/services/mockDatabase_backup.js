...
export default {
  ...
  getMessageById
    ...
    keywords: 'مكتب, إداري, برج, تجاري, غرف, مكيف',
    location: 'المهندسين',
    price: ''
  },
  {
    id: 15,
    sender: 'مكتب النور',
    message: 'فيلا تويناهوس في الشروق 200 متر 3 طوابق حديقة وجراج مغطى',
    timestamp: '1/7/25, 1:15:35 PM',
    property_type: 'villa',
    keywords: 'فيلا, تويناهوس, طوابق, حديقة, جراج',
    location: 'الشروق',
    price: ''
  }
];
...
export const insertMessage = async (messageData) => {
  ...
  const newMessage = {
    ...
    agent_phone: generatePhoneNumber(),
    agent_description: generateAgentDescription(messageData.sender),
    full_description: generateFullDescription(messageData.property_type, 120, messageData.location)
  };
...
// Search messages
export const searchMessages = async (searchTerm = '', propertyType = 'all', limit = 100) => {
  await delay(300);
