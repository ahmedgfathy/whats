  ...
  return (
    <div className="min-h-screen bg-background relative overflow-hidden">
      ...
      <motion.header 
        ...
        className="relative glass border-b border-border/50 shadow-2xl"
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-24">
            ...
            >
              ...
              <div>
                ...
                <div className="flex items-center space-x-2 mt-1">
                  ...
                  <CpuChipIcon className="h-4 w-4 text-primary animate-pulse" />
                  <p className="text-sm text-muted-foreground">تقنية الذكاء الاصطناعي للبحث المتقدم</p>
                </div>
              </div>
            </motion.div>
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              className="group relative overflow-hidden flex items-center px-8 py-4 text-sm font-semibold text-muted-foreground hover:text-foreground glass-light rounded-2xl border border-border/50 transition-all duration-300 shadow-lg"
            >
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        >
          <nav className="relative" dir="rtl">
            <div className="flex space-x-4 glass p-3 rounded-3xl border border-border/50 shadow-2xl">
              {tabs.map((tab) => {
                  ...
                  <motion.button
                    ...
                    className={`relative overflow-hidden px-8 py-6 text-sm font-bold rounded-2xl transition-all duration-500 flex flex-col items-center space-y-2 min-w-[140px] ${
                      isActive
                        ...
                        : 'text-muted-foreground hover:text-foreground glass-light'
                    }`}
                  >
                    {isActive && (
                      <motion.div
          ...
          {activeTab === 'search' && (
            ...
            >
              ...
              >
                ...
                <div className="relative glass-light rounded-3xl border border-border/50 p-10 shadow-2xl">
                  <div className="flex flex-col space-y-8">
                    ...
                    <div className="relative group">
                      ...
                      <div className="relative">
                        <MagnifyingGlassIcon className="absolute left-6 top-1/2 transform -translate-y-1/2 text-muted-foreground h-6 w-6 group-focus-within:text-primary transition-colors duration-300" />
                        <input
                          type="text"
                          placeholder="ابحث عن العقارات المثالية... شقق فاخرة، فيلل، أراضي استثمارية"
                          className="w-full pl-16 pr-8 py-6 bg-background/50 border border-border rounded-2xl focus:ring-2 focus:ring-ring focus:border-primary transition-all duration-300 text-right text-lg placeholder-muted-foreground text-foreground font-medium shadow-lg backdrop-blur-xl"
                          value={searchTerm}
                          onChange={(e) => setSearchTerm(e.target.value)}
                          dir="rtl"
                        />
                        <div className="absolute right-6 top-1/2 transform -translate-y-1/2">
                          <BoltIcon className="h-5 w-5 text-primary animate-pulse" />
                        </div>
                      </div>
                    </div>
                        ...
                        return (
                          <motion.button
                            ...
                            className={`relative overflow-hidden group flex items-center px-8 py-4 text-sm font-bold rounded-2xl transition-all duration-300 ${
                              isSelected
                                ? 'text-white shadow-2xl transform scale-105'
                                : 'text-muted-foreground hover:text-foreground glass border border-border/50'
                            }`}
                          >
                            {isSelected && (
                              <motion.div
                    ...
                    >
                      <div className="text-center p-6 glass rounded-2xl border border-border/50">
        ...
        {activeTab === 'debug' && (
          <motion.div 
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
            className="glass-light rounded-3xl shadow-2xl p-8 border border-border/50"
          >
            <h2 className="text-2xl font-bold text-foreground mb-6 text-right flex items-center justify-end">
              <BugAntIcon className="h-6 w-6 ml-3 text-primary" />
