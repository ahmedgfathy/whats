...
const SearchResults = ({ messages, loading, currentPage, totalPages, totalMessages, onPageChange }) => {
  ...
  const getPropertyTypeColor = (type) => {
    const colors = {
      apartment: 'bg-gradient-to-r from-blue-500/90 to-indigo-500/90 text-white border border-blue-300/50',
      villa: 'bg-gradient-to-r from-emerald-500/90 to-green-500/90 text-white border border-emerald-300/50',
      land: 'bg-gradient-to-r from-amber-500/90 to-orange-500/90 text-white border border-amber-300/50',
      office: 'bg-gradient-to-r from-purple-500/90 to-pink-500/90 text-white border border-purple-300/50',
      warehouse: 'bg-gradient-to-r from-slate-500/90 to-gray-500/90 text-white border border-slate-300/50',
      other: 'bg-gradient-to-r from-gray-500/90 to-slate-500/90 text-white border border-gray-300/50'
    };
    return colors[type] || 'bg-gradient-to-r from-gray-500/90 to-slate-500/90 text-white border border-gray-300/50';
  };
